...
Pls view the revised visualisation on Tableau Public [here](https://stats.mom.gov.sg/Pages/LabourForceTimeSeries.aspx)
...
4.11 Remove the year 2007 from the data set since it is a duplicate set of data using edit  add  select 2007 and click exclude.
...
4.13 Create a new column called “Age Group” to bucket up the Age (years) for easier analysis. 

Right click the Age (Years) column and create group accordingly: a. Young adult (15 – 24), b. Working adult (25 – 39), c. Mid life Worker (40 – 54), d. Retiring (55 – 64), e. Senior (65 – 70 & over)
